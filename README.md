...
## Comenzando
 ...
 2. Descargar el repositorio en Zip.
 3. Descomprimir el archivo en la carpeta donde se encuentre el proyecto.
 4. Hacer un commit inicial ej: `git add .` => `git commit -m "init"` => `git branch -M main`
 5. Seguir las instrucciones de GitHub para 'conectar' su repositorio local con GitHub `git remote add........`
 6. Hacer push de ese commit `git push -u origin main`
...
Adicionalmente será necesario que creen desde psql una base de datos con el nombre de su preferencia.
